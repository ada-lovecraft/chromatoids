...
Phaser.Plugin.MouseSprite.prototype.setMoveCallback = function(callback, context) {
  this.mouseMoveCallback = callback;
  this.mouseMoveCallbackContext = context;
};
...
Phaser.Plugin.MouseSprite.prototype.updateLocation = function() {
  ...
  if(this.mouseMoveCallback) {
    this.mouseMoveCallback.call(this.mouseMoveCallbackContext);
  }
};