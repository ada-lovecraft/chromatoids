...
var SliderEnemy = function(game, x, y, enemyColor, enemySpeed) {
  ...
  this.pollTime = 0;
  this.tbmd = game.add.bitmapData(game.width, game.height);
  this.debugTriangle = game.add.sprite(0,0, this.tbmd);
...
SliderEnemy.prototype.update = function() {
  if(this.pollTime < game.time.now) {
    ...
    var distance = game.physics.arcade.distanceBetween(this, this.player);
    ...
    game.add.tween(this).to(travel, this.pollingSpeed / 2, Phaser.Easing.Linear.NONE, true);
